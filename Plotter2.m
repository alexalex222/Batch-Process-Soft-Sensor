...
h(2) = plot(timings,Pred(:,4), Styles{4},'Color',rgb(Colors(4)),'LineWidth',0.5);
h(3) = plot(timings,Pred(:,5), Styles{5},'Color',rgb(Colors(5)),'LineWidth',0.5);
...
dir = strcat(cd,'\Figs\');
saveas(gcf,[dir,'Result2'],'fig');
maximize;
applytofig(gcf, 'width',8, 'height',8, 'color','rgb', 'resolution',1800, 'bounds','tight');
set(gcf, 'Renderer', 'painters');
saveas(gcf,[dir,'Result2'],'png');
saveas(gcf,[dir,'Result2'],'epsc');
close all;
